...
if(function_exists("register_field_group"))
{
	register_field_group(array (
		...
		'fields' => array (
			array (
				'key' => 'field_5506a9f4a261c',
				'label' => 'Utgångspris',
				'name' => 'asking-price',
				'type' => 'number',
				'instructions' => 'Ange utgångspris i SEK.',
				'required' => 1,
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_5506ae0ee5b24',
				'label' => 'Byggnadsår',
				'name' => 'building-year',
				'type' => 'number',
				'instructions' => 'Ange byggår',
				'required' => 1,
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_5506ae30e5b25',
				'label' => 'Typ av objekt',
				'name' => 'object-type',
				'type' => 'select',
				'instructions' => 'Ange typ av objekt',
				'required' => 1,
				'choices' => array (
					'house: Villa' => 'house: Villa',
					'appartment: Lägenhet' => 'appartment: Lägenhet',
					'plot: Tomt' => 'plot: Tomt',
					'farm: Gård' => 'farm: Gård',
				),
				'default_value' => '',
			...
			array (
				'key' => 'field_5506aee9e5b26',
				'label' => 'Antal rum',
				'name' => 'rooms',
				'type' => 'number',
				'instructions' => 'Ange antal rum',
				'required' => 1,
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_5506b5974f3ad',
				'label' => 'Area i m2',
				'name' => 'area',
				'type' => 'number',
				'instructions' => 'Ange area i kvadratmeter',
				'required' => 1,
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_5506b61c4f3ae',
				'label' => 'Biarea',
				'name' => 'biarea',
				'type' => 'number',
				'instructions' => 'Ange biarea i kvadratmeter.',
				'default_value' => 0,
				'placeholder' => '',
				'prepend' => '',
				'append' => '',
			...
			array (
				'key' => 'field_5506b64f4f3af',
				'label' => 'Driftkostnad per månad',
				'name' => 'running-costs',
				'type' => 'number',
				'instructions' => 'Ange driftkostnad per månad i SEK.',
				'required' => 1,
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_5506b6854f3b0',
				'label' => 'Bilder',
				'name' => 'pictures',
				'type' => 'image',
				'instructions' => 'Ladda upp objektets bilder',
				'save_format' => 'object',
				'preview_size' => 'thumbnail',
				'library' => 'all',
			),
			array (
				'key' => 'field_5506b6be4f3b1',
				'label' => 'Adress',
				'name' => 'adress',
				'type' => 'text',
				'instructions' => 'Ange adress',
				'required' => 1,
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_5506b73e4f3b2',
				'label' => 'Stad',
				'name' => 'city',
				'type' => 'text',
				'instructions' => 'Ange stad.',
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
				'append' => '',
			...
			array (
				'key' => 'field_5506b79c4f3b3',
				'label' => 'Kommun',
				'name' => 'municipality',
				'type' => 'text',
				'instructions' => 'Ange kommun',
				'required' => 1,
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
